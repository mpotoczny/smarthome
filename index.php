...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">APLIKACJA DO ZARZĄDZANIA AUTOMATYKĄ DOMOWĄ - THE SMARTHOME</div>
            </div>
            <div class="row"> 
                <div class="col-md-12">
